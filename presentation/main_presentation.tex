...
\begin{frame}{Ist die Entscheidung zur Festnahme fair?}
    ...
    \begin{columns}[c] % [c] centers the columns vertically
        ...
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=0.8\textwidth]{../figures/police_stop.jpg}
        \end{column}
    \end{columns}
\end{frame}
...
% Kausale Fairness
\begin{frame}{Ist die Gruppenzugehörigkeit die Grund für die Festnahme? \\ - kausale Definitionen}
    \begin{columns}
        \column{0.4\textwidth}
        \centering
...
\begin{frame}
	...
	\begin{itemize}
		\item Preprocessing: Daten vor dem Training bearbeiten \\ z.B. (Re-)Sampling, Transformation
...
\begin{frame}{Wie geht es weiter?}
	...
	\end{itemize}
	\vspace*{1cm}
	\text{Fazit:} Fairness ist ein komplexes Thema, das Zusammenarbeit vieler Disziplinen erfordert
\end{frame}
