...
--> current approach would be to work with the data in a simplified way (complete cases, binary PA) and use the pipelines implemented by mlr3
--> then argue in the expansion/limitation what is wrong with this approach
