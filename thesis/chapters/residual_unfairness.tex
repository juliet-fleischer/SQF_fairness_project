...
The second part of this paper deals with a real worl application of fairness in machine learning. We decided to look at the Stop, Question, and Frisk dataset from the New York Police Department (NYPD). The dataset has been used in fairness research before and illustrates intersting insights and limitations of traditional fairness metrics in their standalone version.
We will first provide some background information about the dataset. In the context of the data the problem of selction bias will be of major importance. We look at two paper that have formalised the concept of fairness under this condition and compare them with another paper that ignores the subtle context of the data.

Problem they identify: Censored data
